    ...
    document.addEventListener('DOMContentLoaded', function () {
        try { updateZoomAwareLines(); } catch (e) { /* import-only init skipped */ }
        try { bindBitmapTextFontRefresh(); } catch (e) { /* import-only init skipped */ }
        try { initNavTabs(); } catch (e) { /* import-only init skipped */ }
        try { initCustomSelect(); } catch (e) { /* import-only init skipped */ }
        try { initFilePath(); } catch (e) { /* import-only init skipped */ }
        try { initImportButton(); } catch (e) { /* import-only init skipped */ }
        try { initImportCheckboxes(); } catch (e) { /* import-only init skipped */ }
        try { initControlTooltips(); } catch (e) { /* import-only init skipped */ }
        try { initGlobalTooltipDismiss(); } catch (e) { /* import-only init skipped */ }
        try { initLogPreview(); } catch (e) { /* import-only init skipped */ }
        try { initDateFilterDefaults(); } catch (e) { /* import-only init skipped */ }
        try { updateImportButtonText(); } catch (e) { /* import-only init skipped */ }
        try { attachLogAreaHandlers(); } catch (e) { /* import-only init skipped */ }
        try { initPageState(); } catch (e) { /* import-only init skipped */ }
        try { renderLogTables(); } catch (e) { /* import-only init skipped */ }
        try { renderStaticText(); } catch (e) { /* import-only init skipped */ }
    });
